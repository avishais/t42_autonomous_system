...
void Gripper::readParametersFromServer(){
	closed_load_ = 0;
	// if(!node_handle_.getParam("finger_close_load", )){
	// 	throw std::runtime_error("[gripper] The parameter finger_close_load is not set.");
	// }

	if(!node_handle_.getParam("finger_initial_offset", finger_initial_offset_)){
		ROS_WARN("[gripper] The parameter finger_initial_offset is not set. Setting the initial offset to zero.");
	...
	if(!node_handle_.getParam("finger_closing_position", finger_closing_position_)){
		ROS_WARN("[gripper] The parameter finger_closing_position is not set. Setting the closing offset to zero.");
	...
	if(!node_handle_.getParam("finger_opening_position", finger_opening_position_)){
		ROS_WARN("[gripper] The parameter finger_opening_position_ is not set. Setting the closing offset to zero.");
