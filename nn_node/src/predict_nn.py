...
import sys
sys.path.insert(0, '/home/pracsys/catkin_ws/src/t42_control/nn_node/common/')
...
class predict_nn:
    def __init__(self):
        ...
        with open(save_path + '/normalization_arr_py2', 'rb') as pickle_file:
...
#         plt.legend()
#         plt.show()
>>>>>>> b4be8ac210c797c960c6ca77d71a1b78704a7897
